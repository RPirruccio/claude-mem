 ...
 * The installed plugin at ~/.claude/plugins/marketplaces/rpirruccio/ is a git repo.
 */
...
const INSTALLED_PLUGIN_PATH = join(homedir(), '.claude', 'plugins', 'marketplaces', 'rpirruccio');
